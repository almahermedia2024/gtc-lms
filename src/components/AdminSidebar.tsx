import { LayoutDashboard, Video, Users, BarChart3, LogOut, BookOpen, ShieldCheck, ClipboardList, PieChart, FileDown } from "lucide-react";
...
const items = [
  ...
  { title: "ملفات الكورسات", url: "/admin/resources", icon: FileDown },
